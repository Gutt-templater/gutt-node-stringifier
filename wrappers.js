module.exports = {
  prefix:
    ...
    '      result.children = children.filter(function (_child) { return _child !== null; });\n' +
    '    }\n' +
    '    return result;\n' +
    '  }\n' +
    ...
    '  return buffer.join(\'\');\n' +
    '}\n' +
    'module.exports = function (__data, ___children, __returnAsObject) {\n' +
    '  var __state;\n' +
    '  if (typeof ___children === \'undefined\') ___children = [];\n' +
    '  if (typeof __returnAsObject === \'undefined\') __returnAsObject = false;\n' +
    ...
    '  var __children = [];\n',
  postfix:
    '  return __returnAsObject ? __children : treeToString(__children);\n' +
    '};'
}
